...
\addvspace {10\p@ }
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {8.1}Bibliotheken der Motor Klasse}{44}{lstlisting.8.1}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {8.2}Konstruktor der Motor Klasse}{45}{lstlisting.8.2}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {8.3}Funktion zum Bewegen des Motors}{46}{lstlisting.8.3}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {8.4}Bibliotheken der Lidar Klasse}{46}{lstlisting.8.4}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {8.5}Kostruktor der Lidar Klasse}{47}{lstlisting.8.5}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {8.6}Funktion um Distanz vom \ac {LIDAR} Sensor zu erhalten}{47}{lstlisting.8.6}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {8.7}Bibliotheken zur Steuerung des Systems}{48}{lstlisting.8.7}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {8.8}Initialisieren von Variablen und Klassen}{49}{lstlisting.8.8}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {8.9}Funktionen f\IeC {\"u}r die \IeC {\"U}bersichtlichkeit des Codes}{50}{lstlisting.8.9}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {8.10}Aufrufen von Funktionen und Variablen deklaration}{51}{lstlisting.8.10}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {8.11}Erstellen der Datei zum Speichern der Daten}{52}{lstlisting.8.11}
\defcounter {refsection}{0}\relax 
\contentsline {lstlisting}{\numberline {8.12}Messen und Aufzeichnen der Entfernungen}{53}{lstlisting.8.12}
\defcounter {refsection}{0}\relax 
\addvspace {10\p@ }
\defcounter {refsection}{0}\relax 
