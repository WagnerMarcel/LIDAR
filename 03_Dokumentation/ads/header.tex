...
\newcommand{\setpagestylehead}{%
    \fancypagestyle{plain}{%
        ...
        \fancyhead[R]{
            ...
            \iflang{de}{\includegraphics[height=1cm]{images/dhbw_de}\hspace{0.5cm}}
            \iflang{en}{\includegraphics[height=1cm, trim=0 0 1cm 0]{images/dhbw_en}}
            \iflang{de}{\includegraphics[height=1cm]{images/Bosch_Logo_DE}}
            \iflang{en}{\includegraphics[height=1cm]{images/Bosch_Logo_EN}}
        }
        \fancyfoot[L]{
